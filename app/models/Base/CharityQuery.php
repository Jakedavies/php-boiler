 ...
 * @method     ChildCharityQuery orderByOwner($order = Criteria::ASC) Order by the owner column
 * @method     ChildCharityQuery orderByDescription($order = Criteria::ASC) Order by the description column
 * @method     ChildCharityQuery orderByPreview($order = Criteria::ASC) Order by the preview column
 *
 * @method     ChildCharityQuery groupById() Group by the id column
 * @method     ChildCharityQuery groupByName() Group by the name column
 * @method     ChildCharityQuery groupByOwner() Group by the owner column
 * @method     ChildCharityQuery groupByDescription() Group by the description column
 * @method     ChildCharityQuery groupByPreview() Group by the preview column
 *
 ...
 *
 * @method     ChildCharityQuery leftJoinUser($relationAlias = null) Adds a LEFT JOIN clause to the query using the User relation
 * @method     ChildCharityQuery rightJoinUser($relationAlias = null) Adds a RIGHT JOIN clause to the query using the User relation
 * @method     ChildCharityQuery innerJoinUser($relationAlias = null) Adds a INNER JOIN clause to the query using the User relation
 *
 ...
 * @method     ChildCharity findOneByOwner(int $owner) Return the first ChildCharity filtered by the owner column
 * @method     ChildCharity findOneByDescription(string $description) Return the first ChildCharity filtered by the description column
 * @method     ChildCharity findOneByPreview(string $preview) Return the first ChildCharity filtered by the preview column *
 ...
 * @method     ChildCharity requireOneByOwner(int $owner) Return the first ChildCharity filtered by the owner column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildCharity requireOneByDescription(string $description) Return the first ChildCharity filtered by the description column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildCharity requireOneByPreview(string $preview) Return the first ChildCharity filtered by the preview column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildCharity[]|ObjectCollection findByOwner(int $owner) Return ChildCharity objects filtered by the owner column
 * @method     ChildCharity[]|ObjectCollection findByDescription(string $description) Return ChildCharity objects filtered by the description column
 * @method     ChildCharity[]|ObjectCollection findByPreview(string $preview) Return ChildCharity objects filtered by the preview column
...
abstract class CharityQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Base\CharityQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'defaultdb', $modelName = '\\Charity', $modelAlias = null)
    {
    ...
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = CharityTableMap::getInstanceFromPool((string) $key))) && !$this->formatter) {
    ...
    {
        $sql = 'SELECT id, name, owner, description, preview FROM charity WHERE id = :p0';
        try {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj->hydrate($row);
            CharityTableMap::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
    ...
    public function filterByOwner($owner = null, $comparison = null)
    {
        if (is_array($owner)) {
            $useMinMax = false;
            if (isset($owner['min'])) {
                $this->addUsingAlias(CharityTableMap::COL_OWNER, $owner['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($owner['max'])) {
                $this->addUsingAlias(CharityTableMap::COL_OWNER, $owner['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(CharityTableMap::COL_OWNER, $owner, $comparison);
    }
    ...
    public function filterByDescription($description = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(CharityTableMap::COL_DESCRIPTION, $description, $comparison);
    }
    ...
    public function filterByPreview($preview = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(CharityTableMap::COL_PREVIEW, $preview, $comparison);
    }
    ...
    public function filterByUser($user, $comparison = null)
    {
        if ($user instanceof \User) {
            return $this
                ->addUsingAlias(CharityTableMap::COL_OWNER, $user->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(CharityTableMap::COL_OWNER, $user->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
