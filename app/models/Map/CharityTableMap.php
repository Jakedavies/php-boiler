...
class CharityTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.CharityTableMap';
     ...
     */
    const OM_CLASS = '\\Charity';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Charity';
     ...
     */
    const COL_OWNER = 'charity.owner';

    /**
     * the column name for the description field
     */
    const COL_DESCRIPTION = 'charity.description';

    /**
     * the column name for the preview field
     */
    const COL_PREVIEW = 'charity.preview';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Owner', 'Description', 'Preview', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'owner', 'description', 'preview', ),
        self::TYPE_COLNAME       => array(CharityTableMap::COL_ID, CharityTableMap::COL_NAME, CharityTableMap::COL_OWNER, CharityTableMap::COL_DESCRIPTION, CharityTableMap::COL_PREVIEW, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'owner', 'description', 'preview', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Owner' => 2, 'Description' => 3, 'Preview' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'owner' => 2, 'description' => 3, 'preview' => 4, ),
        self::TYPE_COLNAME       => array(CharityTableMap::COL_ID => 0, CharityTableMap::COL_NAME => 1, CharityTableMap::COL_OWNER => 2, CharityTableMap::COL_DESCRIPTION => 3, CharityTableMap::COL_PREVIEW => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'owner' => 2, 'description' => 3, 'preview' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('preview', 'Preview', 'VARCHAR', false, 255, null);
    } // initialize()
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CharityTableMap::COL_OWNER);
            $criteria->addSelectColumn(CharityTableMap::COL_DESCRIPTION);
            $criteria->addSelectColumn(CharityTableMap::COL_PREVIEW);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Charity) { // it's a model object
