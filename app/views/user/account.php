...
<div class="row">
    <div class="col-xs-10 col-sm-10 col-xs-offset-1 col-sm-offset-1 history_title">Donation History</div>
</div>
<div class="row">
...
<div class="row">
    <div class="col-sm-8 col-sm-offset-2 col-xs-8 col-xs-offset-2 info_box">
        <div class="row" style="margin-bottom: -10px; margin-top: -10px;">
            ...
            <div class="col-xs-12 col-sm-3 col-xs-offset-0">Charity</div>
            <div class="col-xs-12 col-sm-3 col-xs-offset-0">Date</div>
            <div class="col-xs-12 col-sm-3 col-xs-offset-0">Website</b></div>
        </div>
        <div class="col-xs-12 col-xs-offset-0 divider" style="margin-bottom:10px;"></div>
        <div class="row donation-history-elem">
            <div class="col-xs-12 col-sm-3 col-xs-offset-0">Amount1</div>
            <div class="col-xs-12 col-sm-3 col-xs-offset-0">
                <a href="#">Organization Profile</a>
            </div>
            <div class="col-xs-12 col-sm-3 col-xs-offset-0">Date1</div>
            <div class="col-xs-12 col-sm-3 col-xs-offset-0">
                <a href="#">Organization Website</a>
            </div>
        </div>
        <div class="row donation-history-elem">
...
<div class="row">
    <div class="col-sm-8 col-sm-offset-2 col-xs-8 col-xs-offset-2 info_box">
        ...
        <div class="row">
            <div class="col-sm-5 col-sm-offset-1 contact-elem">NAME</div>
        ...
        <div class="row">
            ...
            <div class="col-sm-5 indent"><input type="checkbox" name="" value="send-emails" style="margin-left: 50px;"/></div>
        </div>
        <div class="row">
            <div class="col-sm-5 col-sm-offset-1 indent">Send Me News and Updates</div>
            <div class="col-sm-5 indent"><input type="checkbox" style="margin-left: 50px;" value="send-updates"/></div>
        </div>
        <div class="row">
            <div class="col-sm-12">
