...
require_once __DIR__ . '/../app/mailer/BaseMailer.php';
require_once __DIR__ . '/../app/mailer/PasswordResetMailer.php';
require_once __DIR__ . '/../app/mailer/VerifyEmailMailer.php';
